    ...
    <>
      <div className={ styles.container } id="lineup">
        ...
        <div data-aos="fade-up" className={styles.features_content}>
          ...
          <div className={styles.features_content_card}>
            <Link to={'Resident-Evil-3-Remake'} spy={true} smooth={true} duration={800}>       
          ...
          <div className={styles.features_content_card}>
            <Link to={'Resident-Evil-4'} spy={true} smooth={true} duration={800}>       
          ...
          <div className={styles.features_content_card}>
            <Link to={'Resident-Evil-5'} spy={true} smooth={true} duration={800}>       
          ...
          <div className={styles.features_content_card}>
            <Link to={'Resident-Evil-6'} spy={true} smooth={true} duration={800}>       
