...
export const InfoUmbrella = {
  title: "Raccoon City é uma cidade industrial localizada no centro-oeste dos Estados Unidos que foi destruída pelo governo americano após a disseminação de um vírus mortal.",
    paragraphOne: "Essa parte montanhosa abrigou a represa da cidade, que abastecia a população, além da vasta Floresta de Raccoon. A cidade era cortada pelo grande Rio Circular, que atravessa a cidade de norte a sul, e sua área central era dividida em “Uptown” e “Downtown” com a maior parte dos estabelecimentos comerciais e prédios importantes, como o Departamento de Polícia de Raccoon City e a Prefeitura.",
    paragraphTwo: "Até 1998, Raccoon City possuía uma população de 100 mil habitantes, sendo classificada como uma metrópole de médio porte. A cidadezinha de outrora se transformou na metrópole com a chegada Umbrella Corporation, incentivando o desenvolvimento local. A empresa chegou à Raccoon City iniciando a construção de novas fábricas, causando o rápido crescimento da cidade. Com o tempo, três de cada dez habitantes eram empregados da Umbrella Corporation.",
    image: Umbrella,
    alt: "Umbrella",
    delay: 100,
}